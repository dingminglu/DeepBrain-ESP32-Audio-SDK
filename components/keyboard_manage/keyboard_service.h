...
typedef enum KEY_EVENT_t
{
	...
	KEY_EVENT_FREE_TALK_CONTINUE,//连续对话
	...
	KEY_EVENT_CHILD_LOCK,		//童锁开关
	KEY_EVENT_OTHER_KEY_CHILD_LOCK_PLAY,	//补全空白按键播报童锁
	KEY_EVENT_HEAD_LED_SWITCH,	//头灯开关
	KEY_EVENT_TRANSLATE,		//连续中英互译
