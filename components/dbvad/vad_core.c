...
// Mode 4, custom.
static const int16_t kOverHangMax1Cus[3] = { 8, 3, 2 };
static const int16_t kOverHangMax2Cus[3] = { 14, 5, 3 };
static const int16_t kLocalThresholdCus[3] = { 200, 96, 96 };
static const int16_t kGlobalThresholdCus[3] = { 1100, 1200, 1300 };
