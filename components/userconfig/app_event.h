...
//mcu service
typedef enum APP_EVENT_MCU_SERIAL_COMM_SERVICE_t
{
	APP_EVENT_MCU_SERIAL_COMM_SERVICE_BASE = APP_EVENT_BASE_NEXT(APP_EVENT_MEMO_BASE),
	APP_EVENT_MCU_SERIAL_COMM_SERVICE_IDLE,
}APP_EVENT_MCU_SERIAL_COMM_SERVICE_t;
